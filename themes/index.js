...
const CategoryTags = dynamic(() => import('./components/CategoryTags'), {
  ssr: false
})
...
// 主题全局状态
const ThemeGlobalParentReport = createContext()
export const useParentReportGlobal = () => useContext(ThemeGlobalParentReport)
...
const LayoutBase = props => {
  ...
  return (
    <ThemeGlobalParentReport.Provider value={{ searchModal }}>
      <div
        id='theme-parent-report'
        ...
        <div
          ...
          className='w-full flex-1 flex items-start max-w-9/10 mx-auto pt-4'>
        ...
        {/* 底部导航栏 - 仅在移动端显示 */}
        {siteConfig('MOBILE_BOTTOM_NAV', null, CONFIG) && <BottomNav {...props} />}

        <Footer {...props} />
      </div>
    </ThemeGlobalParentReport.Provider>
  )
}
  ...
  return (
    <>
      <section className='hero'>
        <h1>学习汇报</h1>
        <p>{siteConfig('TITLE')}的学习情况总结与课程进度报告</p>
        <SearchInput {...props} />
      </section>
